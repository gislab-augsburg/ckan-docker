...
class SpatialHarvester(HarvesterBase):
    ...
    def get_package_dict(self, iso_values, harvest_object):
        ...
        print('--------------------MB_edit_10---base_get_package_dict_01')
...
##            'tags': tags,
##            'resources': [],
##            'author': iso_values['contact'],
##            'author_email': iso_values['contact-email'],
##            'owner_org': iso_values['responsible-organisation'][0]['organisation-name']
##        }
...
##        # MB_edit_01: get iso_values
##        print('MB_edit_01_a__number_of_iso_values:')
##        print(len(iso_values))
##        print('MB_edit_01_b__iso_values_raw:')
##        print(iso_values)
##        #print('MB_edit_01_c__iso_values_structured_I:')
##        #for key, val in iso_values.items():
##            #print('key:', key)
##            #print('val:', val)
##        print('MB_edit_01_d__metadata-standard:')
##        print(iso_values['metadata-standard-name'], iso_values['metadata-standard-version'])
##        print('MB_edit_01_e__responsible-organization:')
##        print(iso_values['responsible-organisation'])
##        print(iso_values['responsible-organisation'][0]['individual-name'])
##        print(iso_values['responsible-organisation'][0]['organisation-name'])
##        print(iso_values['responsible-organisation'][0]['contact-info']['email'])
...
##            print('MB_edit_02__owner_org:')
##            print(source_dataset.owner_org)
        ...
        print('--------------------MB_edit_10---base_get_package_dict_02')
    ...
    def import_stage(self, harvest_object):
        print('--------------------MB_edit_10---base_import_stage_01')
        context = {
            'model': model,
        ...
        print('--------------------MB_edit_10---base_import_stage_02')
        ...
        #print('MB_edit_05__check_package_dict_import:')
        #print(package_dict)
        #print('-----------------------------------------')
        ...
        harvest_object.add()
        print('--------------------MB_edit_10---base_import_stage_03--force_import')
        #print(force_import)
        ...
        if status == 'new':
            ...
            if not self.force_import and previous_object and harvest_object.metadata_modified_date <= previous_object.metadata_modified_date:
                ...
                if not self.force_import:
                    print('######################--MB_edit_12__not self.force_import')
                if previous_object:
                    print('######################--MB_edit_12__previous_object')
                if harvest_object.metadata_modified_date <= previous_object.metadata_modified_date:
                    print('######################--MB_edit_12__date_kleiner_gleich_date_previous')
                    print('harvest_object_date:')
                    print(harvest_object.metadata_modified_date)
                    print('previous_object_date:')
                    print(previous_object.metadata_modified_date)
        ...
        print('--------------------MB_edit_10---base_import_stage_04')
